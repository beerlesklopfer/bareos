...
if(NOT MSVC)
  ...
  check_include_files(pcre2posix.h HAVE_PCRE2_POSIX_H)
  if(NOT HAVE_PCRE2_POSIX_H)
    check_include_files(regex.h HAVE_REGEX_H)
  else()
    # Prevent gtest from including <regex.h> which conflicts with pcre2posix.h
    add_compile_definitions(GTEST_HAS_POSIX_RE=0)
  endif()
